  ...
  const handleGenerateVideo = async (sceneId: string, scene: Scene) => {
    ...
    try {
      ...
      const res = await generateSceneVideo(storyboardId, sceneId, {
        ...
        klingCamHorizontal: vidSettings.klingCamHorizontal,
        klingCamVertical:   vidSettings.klingCamVertical,
        klingCamPan:        vidSettings.klingCamPan,
        klingCamTilt:       vidSettings.klingCamTilt,
        klingCamRoll:       vidSettings.klingCamRoll,
        klingCamZoom:       vidSettings.klingCamZoom,
